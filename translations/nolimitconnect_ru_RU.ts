...
Вы хотите выйти из приложения?</translation>
        ...
        <message>
            ...
            <translation>Групповые хосты объявлены сетевому узлу</translation>
        </message>
        <message>
 ...
 *СЛУЖБА СПИСКА ХОСТОВ ПОЛЬЗОВАТЕЛЕЙ: предоставляет список хостов групп, чатов и случайных подключений, а также их адреса, к которым пользователи могут подключаться, выполнять поиск или присоединяться.
 ...
 *ПЛАГИН «PUSH TO TALK»: предоставляет пользователю голосовое общение одним нажатием кнопки для разговора.
...
=== NOBODY (DISABLED or IGNORED) PERMISSION ===
 ...
 ПРИМЕЧАНИЕ 2. Если вы переведете свое устройство в режим «СЛУЧАЙНОЕ ПОДКЛЮЧЕНИЕ», то другим пользователям, находящимся в режиме «СЛУЧАЙНОЕ ПОДКЛЮЧЕНИЕ», автоматически будет предоставлен уровень гостевых разрешений, и вы можете предоставить отдельным пользователям более высокий уровень разрешений, если хотите.
...
Из-за различных реализаций прошивки маршрутизатора открыть порт удается лишь иногда.  
...
Вам следует изменять URL-адрес сетевого хоста и сетевой ключ только в том случае, если у вас есть
