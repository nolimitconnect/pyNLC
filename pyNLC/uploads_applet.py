...
from resources.Forms.AppletUploads_ui import Ui_AppletUploadsUi
...
class UploadsApplet(QWidget):
    """Python translation of nolimitgui AppletUploads (non-media subset)."""

    def __init__(self, settings=None, parent: QWidget | None = None) -> None:
        super().__init__(parent)
        self.ui = Ui_AppletUploadsUi()
    ...
    def add_file_xfer_state(
        ...
        # Uploads correspond to Tx direction.
        if int(xfer_direction) != 2:
            return
