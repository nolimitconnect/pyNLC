...
class CRenderSystemNlc;

class CTextureBase;
class INlc;

namespace Shaders { class BaseYUV2RGBShaderNlc; }
namespace Shaders { class BaseVideoFilterShaderNlc; }
...
class CRendererNlc : public CBaseRenderer
{
public:
    CRendererNlc();
    virtual ~CRendererNlc();
...
protected:
    ...
    int                         m_currentField;
    int                         m_reloadShaders;
    CRenderSystemNlc *           m_renderSystem;
    ...
    Shaders::BaseYUV2RGBShaderNlc *    m_pYUVProgShader;
    Shaders::BaseYUV2RGBShaderNlc *    m_pYUVBobShader;
    Shaders::BaseVideoFilterShaderNlc * m_pVideoFilterShader;
