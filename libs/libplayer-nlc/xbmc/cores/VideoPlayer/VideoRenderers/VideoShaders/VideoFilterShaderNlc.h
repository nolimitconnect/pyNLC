...
namespace Shaders {
    ...
    class BaseVideoFilterShaderNlc
    {
    public:
        BaseVideoFilterShaderNlc( INlcRender& nlcRender );
    ...
    class ConvolutionFilterShaderNlc : public BaseVideoFilterShaderNlc
    {
    public:
        ConvolutionFilterShaderNlc( INlcRender& nlcRender, ESCALINGMETHOD method );
        ~ConvolutionFilterShaderNlc();
    ...
    class DefaultFilterShaderNlc : public BaseVideoFilterShaderNlc
    {
    public:
        DefaultFilterShaderNlc( INlcRender& nlcRender ) : BaseVideoFilterShaderNlc( INlcRender::getINlcRender() ) {}
        void OnCompiledAndLinked();
        bool OnEnabled();
    };
