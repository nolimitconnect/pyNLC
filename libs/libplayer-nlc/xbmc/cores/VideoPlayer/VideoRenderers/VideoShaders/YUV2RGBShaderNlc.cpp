...
//////////////////////////////////////////////////////////////////////
// BaseYUV2RGBShaderNlc - base class for GLSL YUV2RGB shaders
//////////////////////////////////////////////////////////////////////
//============================================================================
...
//============================================================================
//============================================================================
BaseYUV2RGBShaderNlc::BaseYUV2RGBShaderNlc(  INlcRender& nlcRender, unsigned flags, EShaderFormat format )
: BaseYUV2RGBShader( nlcRender )
{
    ...
    {
         CLog::Log( LOGERROR, "GLES: BaseYUV2RGBShaderNlc - unsupported format %d", m_format );
         m_Valid = false;
    }
...
//============================================================================
BaseYUV2RGBShaderNlc::~BaseYUV2RGBShaderNlc()
{
    Free();
}

//============================================================================
void BaseYUV2RGBShaderNlc::OnCompiledAndLinked()
{
}

//============================================================================
bool BaseYUV2RGBShaderNlc::OnEnabled()
{
     return true;
}

//============================================================================
void BaseYUV2RGBShaderNlc::OnDisabled()
{
}

//============================================================================
void BaseYUV2RGBShaderNlc::Free()
{
}
...
//////////////////////////////////////////////////////////////////////
//============================================================================
YUV2RGBProgressiveShaderNlc::YUV2RGBProgressiveShaderNlc( INlcRender& nlcRender, unsigned flags, EShaderFormat format )
    : BaseYUV2RGBShaderNlc( nlcRender, flags, format )
{
...
//////////////////////////////////////////////////////////////////////
//============================================================================
YUV2RGBBobShaderNlc::YUV2RGBBobShaderNlc( INlcRender& nlcRender, unsigned flags, EShaderFormat format )
    : BaseYUV2RGBShaderNlc( nlcRender, flags, format )
{
    //m_hStepX = -1;
    //m_hStepY = -1;
...
//============================================================================
void YUV2RGBBobShaderNlc::OnCompiledAndLinked()
{
}

//============================================================================
bool YUV2RGBBobShaderNlc::OnEnabled()
{
    if( !BaseYUV2RGBShaderNlc::OnEnabled() )
        return false;
    return true;
}
