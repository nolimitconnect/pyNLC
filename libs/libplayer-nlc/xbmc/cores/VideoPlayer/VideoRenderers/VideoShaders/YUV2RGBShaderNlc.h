...
namespace Shaders {
    ...
    class BaseYUV2RGBShaderNlc
        : public BaseYUV2RGBShader
    {
    public:
        BaseYUV2RGBShaderNlc(  INlcRender& nlcRender, unsigned flags, EShaderFormat format );
        ~BaseYUV2RGBShaderNlc();
    ...
    class YUV2RGBProgressiveShaderNlc : public BaseYUV2RGBShaderNlc
    {
    public:
        YUV2RGBProgressiveShaderNlc(  INlcRender& nlcRender, unsigned flags = 0,
                                  EShaderFormat format = SHADER_NONE );
    };

    class YUV2RGBBobShaderNlc : public BaseYUV2RGBShaderNlc
    {
    public:
        YUV2RGBBobShaderNlc( INlcRender& nlcRender, unsigned flags = 0, EShaderFormat format = SHADER_NONE );
        void                    OnCompiledAndLinked();
        bool                    OnEnabled();
        /*
        GLint                   m_hStepX;
