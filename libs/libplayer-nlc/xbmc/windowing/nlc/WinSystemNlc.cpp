...
#include "WinEventsNlc.h"
#include "OSScreenSaverNlc.h"
...
#include "cores/VideoPlayer/VideoRenderers/RendererNlc.h"
#include "cores/AudioEngine/Sinks/AESinkNlc.h"
#include "cores/AudioEngine/AESinkFactory.h"

using namespace KODI;

//============================================================================
CWinSystemNlc::CWinSystemNlc()
{
    m_displayWidth = 0;
    m_displayHeight = 0;
    ...
    m_winEvents.reset( new CWinEventsNlc() );
    AE::CAESinkFactory::ClearSinks();
    CAESinkNlc::Register(); // register sound sink
}
...
//============================================================================
bool CWinSystemNlc::InitWindowSystem()
{
    m_qt = new CNlcUtils();
...
//============================================================================
bool CWinSystemNlc::DestroyWindowSystem()
{
    delete m_qt;
    m_qt = nullptr;
...
//============================================================================
void CWinSystemNlc::GetConnectedOutputs( std::vector<std::string>* outputs )
{
    if( outputs )
    {
        outputs->push_back( MONITOR_NLC_NAME );
    }
}

//============================================================================
bool CWinSystemNlc::CreateNewWindow( const std::string& name, bool fullScreen, RESOLUTION_INFO& res )
{
...
bool CWinSystemNlc::DestroyWindow()
{
    return true;
}

void CWinSystemNlc::UpdateResolutions()
{
...
bool CWinSystemNlc::Hide()
{
    return false;
}

bool CWinSystemNlc::Show( bool raise )
{
    return false;
}

void CWinSystemNlc::Register( IDispResource *resource )
{
    CSingleLock lock( m_resourceSection );
    m_resources.push_back( resource );
}

void CWinSystemNlc::Unregister( IDispResource *resource )
{
    CSingleLock lock( m_resourceSection );
...
void CWinSystemNlc::MessagePush( XBMC_Event *newEvent )
{
    dynamic_cast< CWinEventsNlc& >( *m_winEvents ).MessagePush( newEvent );
}

bool CWinSystemNlc::MessagePump()
{
    return m_winEvents->MessagePump();
}

std::unique_ptr<WINDOWING::IOSScreenSaver> CWinSystemNlc::GetOSScreenSaverImpl()
{
    std::unique_ptr<KODI::WINDOWING::IOSScreenSaver> ret( new COSScreenSaverNlc() );
    return ret;
}
