...
/************************************************************************/
/************************************************************************/
CWinEventsNlc::CWinEventsNlc()
	: CThread( "CWinEventsNlc" )
{
	CLog::Log( LOGDEBUG, "CWinEventsNlc::CWinEventsNlc" );
...
void CWinEventsNlc::MessagePush( XBMC_Event* newEvent )
{
	// no longer use kodi gui so no need to process events
...
void CWinEventsNlc::MessagePushRepeat( XBMC_Event* repeatEvent )
{
	CSingleLock lock( m_eventsCond );
...
bool CWinEventsNlc::MessagePump()
{
	bool ret = false;
...
size_t CWinEventsNlc::GetQueueSize()
{
	CSingleLock lock( m_eventsCond );
	return m_events.size();
}

void CWinEventsNlc::Process()
{
	uint32_t timeout = 10;
