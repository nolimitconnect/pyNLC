...
{
  return std::make_unique<CSlideShowPicNlc>();
}

void CSlideShowPicNlc::Render(float* x, float* y, CTextureBase* pTexture, UTILS::COLOR::Color color)
{
